...
%PROGRAM% sonnete_17_by_shakespeare.txt %TEMP%\updated_file_copy.txt ""
IF NOT ERRORLEVEL 1 goto error
...
rem Empty search line 
%PROGRAM% sonnete_17_by_shakespeare_one_line.txt %TEMP%\updated_file_copy.txt "" "enjunction"
IF ERRORLEVEL 1 goto error
fc.exe sonnete_17_by_shakespeare_one_line.txt %TEMP%\updated_file_copy.txt
IF ERRORLEVEL 1 goto error
